...
class Mobile{
    ...
    public : 
        ...
        void diffusivity_function_of_tau(const Environment & E, Point X, std::string Reorientation_mode, const std::string & filename, int N_samples, int N_data, double tau_star);
