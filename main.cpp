...
int main(){
    ...
    Point P(0, 0);
    Environment E("empty", 10, 0.4);
    Mobile M(P, 1, 0, 1, 0, 0.5); // v0=10, Dr=0, Tau=1, Theta=0, mu = 0.7

    
    //M.write_trajectory(E, 34792, 0.01 , P, seed, "isotropic", "Trajectories.csv");
    //cout<<M.getMt()<<endl;
    /*
    double D = 0;
    int N = 50;
    ...
    */
    ...
    M.measure_diffusivity(E, 0.1, P, "isotropic", "D_estimation_data.csv", 100000, 500, 1000);
